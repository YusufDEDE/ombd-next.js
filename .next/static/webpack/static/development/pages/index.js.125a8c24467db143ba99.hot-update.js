...
function Card(_ref) {
  ...
  var addFavorite = function addFavorite(object) {
    if (true) {
      mobx_localstorage__WEBPACK_IMPORTED_MODULE_4___default.a.setItem('favorites', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(object));
  ...
  var delFavorite = function delFavorite(index) {
    var newFav = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(favorite);

    newFav.splice(index, 1);
    setFavorite(newFav);
    mobx_localstorage__WEBPACK_IMPORTED_MODULE_4___default.a.setItem('favorites', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(newFav));
    console.log(JSON.parse(mobx_localstorage__WEBPACK_IMPORTED_MODULE_4___default.a.getItem('favorites')));
  };
...
//# sourceMappingURL=index.js.125a8c24467db143ba99.hot-update.js.map