...
function Index(props) {
  ...
  var addFavorite = function addFavorite(object) {
    ...
    mobx_localstorage__WEBPACK_IMPORTED_MODULE_5___default.a.setItem('favorites', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(movielist));
  ...
  var delFavorite = function delFavorite(index) {
    ...
    setFavorite(newFav);
    mobx_localstorage__WEBPACK_IMPORTED_MODULE_5___default.a.setItem('favorites', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(newFav));
    console.log(JSON.parse(mobx_localstorage__WEBPACK_IMPORTED_MODULE_5___default.a.getItem('favorites')));
  };
...
//# sourceMappingURL=index.js.76e3abd29a95972e9db4.hot-update.js.map